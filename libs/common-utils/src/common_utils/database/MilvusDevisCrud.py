...
class ModelConfig:
    ...
    collection_name: str = "devis_poc_64_400"
    dimension: int = 1024
    ...
    def _get_or_create_collection(self, model_config: ModelConfig) -> Collection:
        ...
        if not utility.has_collection(collection_name):
            ...
            fields = [
                ...
                FieldSchema(name="lead_id", dtype=DataType.VARCHAR , max_length=255),
                ...
                FieldSchema(name="effectif", dtype=DataType.VARCHAR, max_length=255),
                FieldSchema(name="prof_ou_part", dtype=DataType.VARCHAR, max_length=64),
                FieldSchema(name="naf2", dtype=DataType.VARCHAR, max_length=64),
                FieldSchema(name="naf5", dtype=DataType.VARCHAR, max_length=64),
                FieldSchema(name="departement", dtype=DataType.VARCHAR, max_length=64),
                FieldSchema(name="region", dtype=DataType.VARCHAR, max_length=64),
                FieldSchema(name="pays", dtype=DataType.VARCHAR, max_length=64),
                FieldSchema(name="critere", dtype=DataType.VARCHAR, max_length=65535),
                FieldSchema(name="societe_acheteur", dtype=DataType.VARCHAR, max_length=64),
            ...
            index_params = {"metric_type": "COSINE", "index_type": "HNSW", "params": {"M": 64, "efConstruction": 400}}
