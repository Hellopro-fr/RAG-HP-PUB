...
Inner worst case drops from ~255 s+ to ~85 s (≤45 s launch + ≤30 s nav + ≤10 s teardown), so the 120 s belt becomes a genuine safety net and stops firing on the normal path.
