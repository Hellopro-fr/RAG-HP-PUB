...
| L2 | `qc-generation-caracteristiques` | `qc-generation-caracteristiques` | UP | shadow | 1 | 21/09 13:39→14:57 Paris (rollback) | DSO 21/09 | — | 🔴 | rollback : HP_TOKEN placeholder (F-HP-MIG-009), corrigé ; rejeu 22/09 |
| L2 | `qc-generation-question1` | `qc-generation-question1` | UP | shadow | 1 | 21/09 13:39→14:57 Paris (rollback) | DSO 21/09 | — | 🔴 | rollback : HP_TOKEN placeholder (F-HP-MIG-009), corrigé ; rejeu 22/09 |
| L2 | `qc-generation-question2an` | `qc-generation-question2an` | UP | shadow | 1 | 21/09 13:39→14:57 Paris (rollback) | DSO 21/09 | — | 🔴 | rollback : HP_TOKEN placeholder (F-HP-MIG-009), corrigé ; rejeu 22/09 |
| L2 | `qc-generation-valeurs` | `qc-generation-valeurs` | UP | shadow | 1 | 21/09 13:39→14:57 Paris (rollback) | DSO 21/09 | — | 🔴 | rollback : HP_TOKEN placeholder (F-HP-MIG-009), corrigé ; rejeu 22/09 |
