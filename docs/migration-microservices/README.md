...
| [`rapports/`](rapports/) | **Un rapport par service basculé** : ce qui a changé, ce qui est prouvé, et **comment tu accèdes maintenant à ton service** (logs, shell, file) — [`deepseek-metrics-collector-service`](rapports/deepseek-metrics-collector-service.md) · [`nettoyage-bruit-ocr-service`](rapports/nettoyage-bruit-ocr-service.md) (L1) · [`qc-caracterisation`](rapports/qc-caracterisation.md) · [`qc-enrichissement`](rapports/qc-enrichissement.md) · [`qc-equivalence`](rapports/qc-equivalence.md) · [`qc-generation-caracteristiques`](rapports/qc-generation-caracteristiques.md) · [`qc-generation-question1`](rapports/qc-generation-question1.md) · [`qc-generation-question2an`](rapports/qc-generation-question2an.md) · [`qc-generation-valeurs`](rapports/qc-generation-valeurs.md) (L2) · [`prix-extraction-produits`](rapports/prix-extraction-produits.md) · [`prix-extraction-message`](rapports/prix-extraction-message.md) · [`prix-extraction-devis`](rapports/prix-extraction-devis.md) · [`prix-caracterisation`](rapports/prix-caracterisation.md) · [`prix-milvus-processor`](rapports/prix-milvus-processor.md) (L3) · [`website-processor-service`](rapports/website-processor-service.md) · [`product-processor-service`](rapports/product-processor-service.md) · [`echange-processor-service`](rapports/echange-processor-service.md) · [`devis-processor-service`](rapports/devis-processor-service.md) · [`website-database-qdrant-service`](rapports/website-database-qdrant-service.md) · [`product-database-qdrant-service`](rapports/product-database-qdrant-service.md) · [`echange-database-qdrant-service`](rapports/echange-database-qdrant-service.md) · [`document-database-qdrant-service`](rapports/document-database-qdrant-service.md) · [`di-database-qdrant-service`](rapports/di-database-qdrant-service.md) (L4) |
