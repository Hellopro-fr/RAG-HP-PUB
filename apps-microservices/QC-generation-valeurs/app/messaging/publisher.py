...
class Publisher:
    """Publisher: QC-generation-valeurs → Publie vers QC-enrichissement"""
    def __init__(self, connection: pika.BlockingConnection):
        ...
        print("✅ QC-Valeurs Publisher initialisé.")
    ...
    def publish_message(self, message_dict: dict):
        ...
        for i in range(3):
            try:
                ...
                print(f"   📤 QC-Valeurs: Message publié vers {self.routing_key}")
                break
