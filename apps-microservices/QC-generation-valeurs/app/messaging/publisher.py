...
class Publisher:
    """Async Publisher: QC-generation-valeurs → Publie vers QC-enrichissement"""
    ...
    async def setup(self, channel: aio_pika.abc.AbstractChannel):
        ...
        logger.info(f"✅ QC-Valeurs Publisher initialized: {self.exchange_name}")
    ...
    async def publish_message(self, message_dict: dict):
        ...
        logger.info(f"📤 QC-Valeurs: Message publié vers {self.routing_key}")
