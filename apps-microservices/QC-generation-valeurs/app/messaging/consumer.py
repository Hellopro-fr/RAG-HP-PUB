...
class Consumer:
    """Async Consumer pour le service QC-generation-valeurs (step 4)."""
    ...
    async def connect(self):
        ...
        logger.info("✅ QC-Valeurs Consumer initialized")
    ...
    async def start_consuming(self):
        ...
        await self.connect()
        logger.info(f"👂 QC-Valeurs: En attente sur {self.queue_name}")
