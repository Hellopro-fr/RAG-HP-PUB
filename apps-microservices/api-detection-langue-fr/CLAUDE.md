...
Consequence: before the fix, at the batch's effective concurrency of 8, duplicated model copies accounted for **~1.0 GiB** of peak (8 × 125.2 MiB = 1001 MiB), plus roughly **12–19 GiB of synchronous disk reads per 98-domain run** (~100–150 loads × 125 MiB) issued from the event-loop thread.
