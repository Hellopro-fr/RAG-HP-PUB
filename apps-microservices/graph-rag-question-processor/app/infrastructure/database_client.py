"""
Graph Database Client for graph-rag-question-processor.
...
# Singleton instance - note: no 'channel' attribute now
graph_database_client_instance = GraphDatabaseClient()
