...
def process_fournisseurs_data_for_embedding(fournisseurs_data: dict,bdd: str = "qdrant") -> dict:
    """
    ...
    metadata = {
        key: value
        for key, value in fournisseurs_data.items() if key not in ['text']
    }
