...
/**
 * Widget interactif du CTA de CTABlock — isolé en client component ciblé.
 * Le bandeau (titre + sous-titre + icône) est un Server Component pur ; seul ce
 * bouton (ouverture de modale au clic) a besoin du client. Le clic ne pousse
 * aucun analytics ; le tracking vit dans les modales (déclenché à l'ouverture).
 */
...
export function CtaBlockAction({ ctaUrl, ctaLabel }: CtaBlockActionProps) {
