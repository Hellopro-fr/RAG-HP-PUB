...
class Publisher:
    """Publisher: QC-enrichissement → Publie vers QC-equivalence"""
    def __init__(self, connection: pika.BlockingConnection):
        ...
        print("✅ QC-Enrichissement Publisher initialisé.")
    ...
    def publish_message(self, message_dict: dict):
        ...
        for i in range(3):
            try:
                ...
                print(f"   📤 QC-Enrichissement: Message publié vers {self.routing_key}")
                break
