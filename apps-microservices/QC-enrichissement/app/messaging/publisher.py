...
class Publisher:
    """Async Publisher: QC-enrichissement → Publie vers QC-equivalence"""
    ...
    async def setup(self, channel: aio_pika.abc.AbstractChannel):
        ...
        logger.info(f"✅ QC-Enrichissement Publisher initialized: {self.exchange_name}")
    ...
    async def publish_message(self, message_dict: dict):
        ...
        logger.info(f"📤 QC-Enrichissement: Message publié vers {self.routing_key}")
