...
class Consumer:
    """Consumer pour le service QC-enrichissement (step 5)."""
    def __init__(self, connection: pika.BlockingConnection, publisher: Publisher):
        ...
        self.queue_name = 'qc_enrichissement_queue'
        ...
        self.connect()
        print("✅ QC-Enrichissement Consumer initialisé.")
    ...
    def _send_to_dlq(self, ch, method, body, error: Exception, retry_count: int):
        ...
        try:
            dlq_props = DLQProperties.create_dlq_properties(error, 'qc-enrichissement', retry_count, method)
    ...
    def _on_message_callback(self, ch, method, properties, body):
        ...
        try:
            print("📥 QC-Enrichissement: Message reçu.")
            ...
            print(f"\n📥 QC-Enrichissement: Traitement catégorie '{id_categorie}'.")
            ...
            try:
                result = loop.run_until_complete(generator.generate_enrichissement(request))
            ...
            active_ch = self._ensure_channel_open(ch)
            active_ch.basic_ack(delivery_tag=method.delivery_tag)
            print(f"✅ QC-Enrichissement: Catégorie '{id_categorie}' traitée.")
    ...
    def start_consuming(self):
        ...
        for i in range(3):
            try:
                ...
                print("👂 QC-Enrichissement: En attente de messages...")
