...
class ProduitPrixPayload(BaseModel):
    """
    Schéma de validation du payload publié vers prix-normalisation pour la source 'produits'.
    Correspond au format retourné par get_produit_prix() (BO/api/v2/prix.php).
    """
