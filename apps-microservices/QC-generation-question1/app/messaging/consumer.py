...
class Consumer:
    """Async Consumer pour le service QC-generation-question1 (step 1)."""
    ...
    async def connect(self):
        ...
        logger.info("✅ QC-Question1 Consumer initialized")
    ...
    async def start_consuming(self):
        ...
        await self.connect()
        logger.info(f"👂 QC-Question1: En attente sur {self.queue_name}")
