...
async function handleSubmit() {
  ...
  try {
    ...
    errorMessage.value =
      msg === 'access_denied' ? 'Invalid username or password.' :
          ...
          <div class="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
            <div>
              <div class="mb-5 sm:mb-8 text-center">
                <h1
                  class="mb-2 text-3xl font-bold text-gray-800 dark:text-white/90"
                >
                  <span class="text-blue-600">HELLO</span>PRO
                </h1>
                <p class="text-sm text-gray-500 dark:text-gray-400">
                  Connectez-vous à votre compte
                </p>
              </div>
              <form @submit.prevent="handleSubmit" data-test="signin-form">
                <div class="space-y-5">
                  <!-- Username -->
                  <div>
                    <label
                    ...
                    <input
                      ...
                      data-test="username"
                      class="h-11 w-full rounded-lg border border-gray-300 bg-transparent px-4 py-2.5 text-sm text-gray-800 shadow-sm placeholder:text-gray-400 focus:border-blue-300 focus:outline-none focus:ring focus:ring-blue-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90 dark:placeholder:text-white/30 dark:focus:border-blue-800"
                    />
                  </div>
                  <!-- Password -->
                  <div>
                  ...
                  <p
                    v-if="errorMessage"
                    class="text-sm font-bold text-center text-red-500"
                    data-test="error"
                  >
                    {{ errorMessage }}
                  </p>
                  ...
                  <div>
                    <button
                      ...
                      :disabled="submitting"
                      data-test="submit"
                      class="flex items-center justify-center w-full px-4 py-3 text-sm font-medium text-white transition rounded-lg bg-blue-600 shadow-sm hover:bg-blue-700 disabled:opacity-50"
                    >
