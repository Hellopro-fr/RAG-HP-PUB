import pika
import json
from fournisseurs_database_qdrant_service.messaging.publisher import Publisher  # Importe notre publisher local
from fournisseurs_database_qdrant_service.core.processor import insertion_data # Importe la logique métier
...
class Consumer:
    def __init__(self, connection: pika.BlockingConnection, publisher: Publisher):
        ...
        self.exchange_name = 'fournisseurs_embedded_data_exchange'

        # à modifier selon le flow de l'application
        self.routing_key = 'data.fournisseurs.ready_for_insertion'

        # Todo: à vérifier si le nom de la queue est correct
        self.queue_name = 'insertion_fournisseurs_queue'
    ...
    def _on_message_callback(self, ch, method, properties, body):
        ...
        print(f"\n📥 Database-Fournisseurs-Processor: Message reçu.")
    ...
    def start_consuming(self):
        ...
        print("👂 Database-Fournisseurs-Processor: En attente de messages...")
