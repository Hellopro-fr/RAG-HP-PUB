// [DEPRECATED] Ce hook a été consolidé dans useProcessMatching.ts
// - refetchMatchingWithUpdatedCriteria → déplacé dans useProcessMatching.ts
// - submitProfile → inliné dans profile-client.tsx
//
// Ce fichier est conservé pour référence. Plus aucun consommateur ne l'importe.
