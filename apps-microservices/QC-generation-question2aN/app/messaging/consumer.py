...
class Consumer:
    """Async Consumer pour le service QC-generation-question2aN (step 2)."""
    ...
    async def connect(self):
        ...
        logger.info("✅ QC-Question2aN Consumer initialized")
    ...
    async def start_consuming(self):
        ...
        await self.connect()
        logger.info(f"👂 QC-Question2aN: En attente sur {self.queue_name}")
