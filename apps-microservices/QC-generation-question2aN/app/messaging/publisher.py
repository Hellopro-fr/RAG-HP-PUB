...
class Publisher:
    """Publisher: QC-generation-question2aN → Publie vers QC-generation-caracteristiques"""
    def __init__(self, connection: pika.BlockingConnection):
        ...
        print("✅ QC-Question2aN Publisher initialisé.")
    ...
    def publish_message(self, message_dict: dict):
        ...
        for i in range(3):
            try:
                ...
                print(f"   📤 QC-Question2aN: Message publié vers {self.routing_key}")
                break
