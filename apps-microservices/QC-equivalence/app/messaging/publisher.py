...
class Publisher:
    """Publisher: QC-equivalence → Publie vers QC-caracterisation"""
    def __init__(self, connection: pika.BlockingConnection):
        ...
        print("✅ QC-Equivalence Publisher initialisé.")
    ...
    def publish_message(self, message_dict: dict):
        ...
        for i in range(3):
            try:
                ...
                print(f"   📤 QC-Equivalence: Message publié vers {self.routing_key}")
                break
