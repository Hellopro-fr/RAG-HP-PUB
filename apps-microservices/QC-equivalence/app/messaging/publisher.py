...
class Publisher:
    """Async Publisher: QC-equivalence → Publie vers QC-caracterisation"""
    ...
    async def setup(self, channel: aio_pika.abc.AbstractChannel):
        ...
        logger.info(f"✅ QC-Equivalence Publisher initialized: {self.exchange_name}")
    ...
    async def publish_message(self, message_dict: dict):
        ...
        logger.info(f"📤 QC-Equivalence: Message publié vers {self.routing_key}")
