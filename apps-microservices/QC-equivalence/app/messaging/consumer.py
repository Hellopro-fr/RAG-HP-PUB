...
class Consumer:
    """Consumer pour le service QC-equivalence (step 6)."""
    def __init__(self, connection: pika.BlockingConnection, publisher: Publisher):
        ...
        self.connect()
        print("✅ QC-Equivalence Consumer initialisé.")
    ...
    def _send_to_dlq(self, ch, method, body, error: Exception, retry_count: int):
        ...
        try:
            dlq_props = DLQProperties.create_dlq_properties(error, 'qc-equivalence', retry_count, method)
    ...
    def _on_message_callback(self, ch, method, properties, body):
        ...
        try:
            print("📥 QC-Equivalence: Message reçu.")
            ...
            print(f"\n📥 QC-Equivalence: Traitement catégorie '{id_categorie}'.")
            ...
            try:
                result = loop.run_until_complete(generator.generate_all_equivalences(request))
            ...
            active_ch = self._ensure_channel_open(ch)
            active_ch.basic_ack(delivery_tag=method.delivery_tag)
            print(f"✅ QC-Equivalence: Catégorie '{id_categorie}' traitée.")
    ...
    def start_consuming(self):
        ...
        for i in range(3):
            try:
                ...
                print("👂 QC-Equivalence: En attente de messages...")
