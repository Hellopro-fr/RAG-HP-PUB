import pika
import json
from echange_service.messaging.publisher import Publisher  # Importe notre publisher local
from echange_service.core.processor import process_echange_data_for_embedding # Importe la logique métier
...
class Consumer:
    ...
    def _on_message_callback(self, ch, method, properties, body):
        ...
        if not echange_data:
            print("❌ Echange-Processor: Aucune donnée de produit trouvée dans le message.")
        ...
        print(f"\n📥 Echange-Processor: Message reçu pour '{id_echange}'.")
