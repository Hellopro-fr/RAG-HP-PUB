...
class Consumer:
    """Async Consumer pour le service QC-caracterisation (step 7 - dernier)."""
    ...
    async def connect(self):
        ...
        logger.info("✅ QC-Caracterisation Consumer initialized")
    ...
    async def process_message(self, message: AbstractIncomingMessage):
        ...
        async with message.process(ignore_processed=True):
            ...
            try:
                ...
                # Dernier service: notification de fin de pipeline
                ...
                await message.ack()
                logger.info(f"[CAT-{id_categorie}] ✅ Traitement terminé avec succès. Pipeline terminé!")
    ...
    async def start_consuming(self):
        ...
        await self.connect()
        logger.info(f"👂 QC-Caracterisation: En attente sur {self.queue_name}")
