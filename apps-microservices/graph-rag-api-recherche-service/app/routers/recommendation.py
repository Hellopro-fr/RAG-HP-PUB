...
from app.domain.models import ComplexFilterRequest, FilterCaracteristiqueRequest, ResultProduct, MatchingPayload, MatchingResponse, Produit, CaracteristiqueMatching
