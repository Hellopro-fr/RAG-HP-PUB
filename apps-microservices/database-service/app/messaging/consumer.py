import pika
import json
from database_service.messaging.publisher import Publisher  # Importe notre publisher local
from database_service.core.processor import insertion_data # Importe la logique métier
...
class Consumer:
    def __init__(self, connection: pika.BlockingConnection, publisher: Publisher):
        ...
        self.queue_name = 'insertion_product_queue'
