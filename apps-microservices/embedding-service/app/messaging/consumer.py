...
class Consumer:
    ...
    def _on_message_callback(self, ch, method, properties, body):
        ...
        try:
            ...
            dlq_props = DLQProperties.create_dlq_properties(e, 'embedding-service', 0, method)
            ...
            if retry_count < MAX_RETRIES:
                ...
                dlq_props = DLQProperties.create_dlq_properties(e, 'embedding-service', MAX_RETRIES, method)
                ch.basic_publish(exchange=self.dead_letter_exchange, routing_key=self.routing_key, body=body, properties=dlq_props)
